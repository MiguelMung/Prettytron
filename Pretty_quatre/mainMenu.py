...
from Pretty_quatre.Adaline import *
from Pretty_quatre.multilayer import *
from Pretty_quatre.Perceptron import *
...
class mainMenu(FloatLayout):
    ...
    def pr_f(self):
        ...
        for i in range(len(self.Entry_x)):
            new_e.append([self.Entry_x[i][1], self.Entry_x[i][2]])

        self.adaline = RBF(new_e, 100, .001, 2)
